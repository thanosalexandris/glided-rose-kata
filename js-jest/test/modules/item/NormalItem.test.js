...
describe('Normal Item', () => {
    ...
    it('should decrease quality twice as fast when sellIn is negative for normal items', () => {
        const item = new NormalItem_1.default('Normal Item', -1, 10);
        item.updateQuality();
